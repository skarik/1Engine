	...
	: CBaseRandomMelee( tMeleeWeaponProperties(), ItemData() )
{
	//iBladeType = 0;
	//iGripType = 0;
	sBladeModel	= "models/weapons/swordssu/blade1.fbx";
	sGripModel	= "models/weapons/swordssu/grip1.fbx";
	holdType = Item::Sword;
}
...
void CRWSwordShortShitty::Generate ( void )
{
	...
	/*string swordModel = "models\\weapons\\swordssu\\blade1.FBX";
	string gripModel = "models\\weapons\\swordssu\\grip1.FBX";

	if ( iBladeType == 0 )
		swordModel = "models\\weapons\\swordssu\\blade1.FBX";
	else if ( iBladeType == 1 )
		swordModel = "models\\weapons\\swordssu\\blade2.FBX";
	else if ( iBladeType == 2 )
		swordModel = "models\\weapons\\swordssu\\blade3.FBX";
	else if ( iBladeType == 3 )
		swordModel = "models\\weapons\\swordssu\\blade4.FBX";
	else if ( iBladeType == 4 )
		swordModel = "models\\weapons\\swordssu\\blade5.FBX";

	pModel = new CModel( swordModel );
	pModel->transform.scale.y = weapon_stats.reach / 2.5f;

	if ( iGripType == 0 )
		gripModel = "models\\weapons\\swordssu\\grip1.FBX";
	else if ( iGripType == 1 )
		gripModel = "models\\weapons\\swordssu\\grip2.FBX";
	else if ( iGripType == 2 )
		gripModel = "models\\weapons\\swordssu\\grip3.FBX";
	else if ( iGripType == 3 )
		gripModel = "models\\weapons\\swordssu\\grip4.FBX";
	else if ( iGripType == 4 )
		gripModel = "models\\weapons\\swordssu\\grip5.FBX";
