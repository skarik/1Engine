...
// Human race table
//=========================================//
RACES.races[1] = Object.create(RACES.races[0]);
...
// Drow race table
//=========================================//
RACES.races[2] = Object.create(RACES.races[0]);
...
// Dwarf race table
//=========================================//
RACES.races[3] = Object.create(RACES.races[0]);
...
//=========================================//
RACES.races[4] = Object.create(RACES.races[0]);
...
// Fluxxor race table
//=========================================//
RACES.races[5] = Object.create(RACES.races[0]);
...
// Merchant race table
//=========================================//
RACES.races[6] = Object.create(RACES.races[0]);
