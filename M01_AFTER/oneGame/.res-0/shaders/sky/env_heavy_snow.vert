...
void main ( void )
{
	...
	v2f_texcoord0.x = v2f_texcoord0.x*2;
	v2f_texcoord0.y = v2f_texcoord0.y*4;*/
	v2f_texcoord0	= vec2(
		(sin(v2f_offset.x*2.1)+sin(v2f_offset.y*2.1))*0.4
		-(v2f_position.x*v2f_normals.y)
		+(v2f_position.y*v2f_normals.x),v2f_position.z )*0.2;
	v2f_texcoord0.y += sys_Time.y*0.5;
