...
#if !defined(HK_EXCLUDE_FEATURE_RegisterVersionPatches) && (HK_SERIALIZE_MIN_COMPATIBLE_VERSION_INTERNAL_VALUE == HK_HAVOK_VERSION_Current)
	// If the minimum compatible version is the current one, no patching is needed on the loaded files.
