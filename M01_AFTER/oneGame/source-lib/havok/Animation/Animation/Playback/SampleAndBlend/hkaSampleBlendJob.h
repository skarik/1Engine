...
public:
	...
	struct SingleAnimation
	{
		...
		void build(const hkaAnimationControl& control, int& maxChunkBytesInOut);

		void build(	const hkaAnimation& anim,
					hkReal localTime,
	...
	void addAnimation(	const hkaAnimation& anim,
						hkReal localTime,
						hkQsTransform* bonesOut,
						hkReal* floatsOut,
