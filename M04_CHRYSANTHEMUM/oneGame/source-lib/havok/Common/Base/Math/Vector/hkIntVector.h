...
class hkIntVector
{
	public:
		...
		// Some platforms enforce valid floats in hardware
		// This stores the ints in the form used by getInt24W
		HK_FORCE_INLINE static const hkIntVector HK_CALL castForInt24(const hkVector4& x);
		HK_FORCE_INLINE static const hkVector4 HK_CALL castForInt24(const hkIntVector& x);
#else
		HK_FORCE_INLINE static const hkIntVector HK_CALL castForInt24(const hkVector4& x) { return cast(x); }
		HK_FORCE_INLINE static const hkVector4 HK_CALL castForInt24(const hkIntVector& x) { return cast(x); }
#endif
			/// Clear
