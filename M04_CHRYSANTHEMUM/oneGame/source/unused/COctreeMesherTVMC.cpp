...
struct COctreeMesher::TransitionSampleData
{
	Vector3d high [9];
	Vector3d low [4];
};
...
void COctreeMesher::Triangulate_TVMC( Real x, Real y, Real z )
{
...
void COctreeMesher::Triangulate_TVMC_BORDER( Real x, Real y, Real z, const uint border )
{
	const ftype n_halfStep = m_step * 0.5;
...
const COctreeMesher::TransitionSampleData COctreeMesher::transitionSampleData[6] =
{
...
struct COctreeMesher::RegularCellData
{
...
struct COctreeMesher::TransitionCellData
{
...
const unsigned char COctreeMesher::regularCellClass[256] =
{
...
const COctreeMesher::RegularCellData COctreeMesher::regularCellData[16] =
{
	{0x00, {}},
	{0x31, {0, 1, 2}},
	{0x62, {0, 1, 2, 3, 4, 5}},
...
const unsigned short COctreeMesher::regularVertexData[256][12] =
{
	{},
...
const unsigned char COctreeMesher::transitionCellClass[512] =
{
...
const COctreeMesher::TransitionCellData COctreeMesher::transitionCellData[56] =
{
	{0x00, {}},
	{0x42, {0, 1, 3, 1, 2, 3}},
	{0x31, {0, 1, 2}},
...
const unsigned char COctreeMesher::transitionCornerData[13] =
{
...
const unsigned short COctreeMesher::transitionVertexData[512][12] =
{
	{},
