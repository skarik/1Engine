...
bool UIDragHandleRenderer::Render ( const char pass )
{
	...
	if ( m_ui->m_style == UIDragHandle::DrawStyle::s2D )
	{
		...
		meshpoints[0] = Vector2d( m_ui->m_position.x - 1.0F, m_ui->m_position.y + 1.0F );
		meshpoints[1] = Vector2d( m_ui->m_position.x + 16.0F, m_ui->m_position.y + 1.0F );
		meshpoints[2] = Vector2d( m_ui->m_position.x + 16.0F, m_ui->m_position.y - 16.0F );
		meshpoints[3] = Vector2d( m_ui->m_position.x - 1.0F, m_ui->m_position.y - 16.0F );
		PushQuad();
		...
		meshpoints[0] = Vector2d( m_ui->m_position.x, m_ui->m_position.y + 1.0F );
		meshpoints[1] = Vector2d( m_ui->m_position.x, m_ui->m_position.y - 1.0F );
		meshpoints[2] = Vector2d( m_ui->m_position.x + 64.0F, m_ui->m_position.y - 1.0F );
		meshpoints[3] = Vector2d( m_ui->m_position.x + 64.0F, m_ui->m_position.y + 1.0F );
		PushQuad();

		meshpoints[0] = Vector2d( m_ui->m_position.x + 64.0F, m_ui->m_position.y );
		meshpoints[1] = Vector2d( m_ui->m_position.x + 64.0F, m_ui->m_position.y + 4.0F );
		meshpoints[2] = Vector2d( m_ui->m_position.x + 80.0F, m_ui->m_position.y );
		meshpoints[3] = Vector2d( m_ui->m_position.x + 64.0F, m_ui->m_position.y - 4.0F );
		PushQuad();
		...
		meshpoints[0] = Vector2d( m_ui->m_position.x + 1.0F, m_ui->m_position.y );
		meshpoints[1] = Vector2d( m_ui->m_position.x - 1.0F, m_ui->m_position.y );
		meshpoints[2] = Vector2d( m_ui->m_position.x - 1.0F, m_ui->m_position.y - 64.0F );
		meshpoints[3] = Vector2d( m_ui->m_position.x + 1.0F, m_ui->m_position.y - 64.0F );
		PushQuad();

		meshpoints[0] = Vector2d( m_ui->m_position.x, m_ui->m_position.y - 64.0F );
		meshpoints[1] = Vector2d( m_ui->m_position.x + 4.0F, m_ui->m_position.y - 64.0F );
		meshpoints[2] = Vector2d( m_ui->m_position.x, m_ui->m_position.y - 80.0F );
		meshpoints[3] = Vector2d( m_ui->m_position.x - 4.0F, m_ui->m_position.y - 64.0F );
		PushQuad();
	}
