...
//		[float][16] transformation matrix of the bone in world space. Supposed to be column-major. (bind pose)
...
//							vSkeleton[target]->effect = 11; // should be constants
//						}
