	...
	, main_editor(editor)
{
	...
	sideLayout->m_padding = Vector2f(5, 5);
	sideLayout->m_margin = Vector2f(5, 5);
...

	{
		...
		dusk_interface->Add<dusk::elements::Label>(dusk::ElementCreationDescription(vLayout, Rect(0, 0, 80, 20)))
			->m_contents = "Bias";
		auto slider_total_bias = dusk_interface->Add<dusk::elements::Slider<float>>(dusk::ElementCreationDescription(vLayout, Rect(0, 0, 80, 20)));
		slider_total_bias->m_range_min = -1.0F;
		slider_total_bias->m_range_max = +1.0F;
		slider_total_bias->m_snap_divisor = 0.1F;
		...
		dusk_interface->Add<dusk::elements::Label>(dusk::ElementCreationDescription(vLayout, Rect(0, 0, 80, 20)))
			->m_contents = "Scale";
		auto slider_total_scale = dusk_interface->Add<dusk::elements::Slider<float>>(dusk::ElementCreationDescription(vLayout, Rect(0, 0, 80, 20)));
		slider_total_scale->m_range_min = -1.0F;
		slider_total_scale->m_range_max = +1.0F;
		slider_total_scale->m_snap_divisor = 0.1F;
