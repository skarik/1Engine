...
public:
	...
	CORE_API explicit		COSF_Loader ( FILE* file );
	//		Destructor
	// NOTE: Does not close the input FILE.
	CORE_API				~COSF_Loader( void );
...
public:
	...
	CORE_API bool			GetNext ( mccOSF_entry_info_t&, char* output_value=NULL );
