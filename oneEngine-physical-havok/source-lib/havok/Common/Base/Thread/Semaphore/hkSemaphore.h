...
#if (defined(HK_PLATFORM_MACPPC) || defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_IOS) || defined(HK_PLATFORM_LINUX) || defined(HK_PLATFORM_LRB) || defined(HK_PLATFORM_ANDROID)) && (HK_CONFIG_THREAD == HK_CONFIG_MULTI_THREADED)
...
#elif defined(HK_PLATFORM_CAFE) && (HK_CONFIG_THREAD == HK_CONFIG_MULTI_THREADED)
