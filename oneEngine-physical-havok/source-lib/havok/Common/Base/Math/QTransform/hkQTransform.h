...
#	error Please include Common/Base/hkBase.h instead of this file.
	...
	/// An hkQTransform represents a T*R transformation where translation is
	/// represented with a vector4 and rotation is represented with a quaternion.
	/// When applied to a point (hkVector4::setTransformedPos()), the point is first rotated and
	/// then translated.
class hkQTransform
{
public:
	...
	HK_FORCE_INLINE bool _isApproximatelyEqual( const hkQTransform& other, hkSimdRealParameter epsilon) const;
